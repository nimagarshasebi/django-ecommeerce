...
from .views import ProductListView,index,productdetail,checkout,search,account_order,orderitem,cart_add_index,cart_add_category,address_none
...
urlpatterns = [
    ...
    path('address-none/',address_none,name='address_none'),
